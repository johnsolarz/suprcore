...
<?php if (have_posts()) : ?>
	...
	<?php if (  $wp_query->max_num_pages > 1 ) : ?>
		...
		<div class="pagination grid_8 alpha">
			<div class="grid_4 alpha alignleft"><?php next_posts_link(__('Older', '')) ?></div>
			<div class="grid_4 omega alignright"><?php previous_posts_link(__('Newer ', '')) ?></div>
		</div>
